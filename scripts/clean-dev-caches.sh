...
#
# Usage:
#   ./script/clean-dev-caches.sh           # interactive mode
#   ./script/clean-dev-caches.sh --dry-run # show sizes without deleting
#
...
as_dirs=""
as_count=0
# Collect all AndroidStudio directories, sorted
